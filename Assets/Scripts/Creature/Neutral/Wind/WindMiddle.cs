...
public class WindMiddle : NeutralObject
{
    private static string configPath = "Fist/Neutral/Wind/WindMiddle/Documents/config";
    ...
    public static void WindMiddleIntialize()
    {
        // InitializeConfig
        InitializeConfig();
    }

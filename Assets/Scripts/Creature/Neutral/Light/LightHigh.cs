...
public class LightHigh : NeutralObject
{
    private static string configPath = "Fist/Neutral/Light/LightHigh/Documents/config";
    ...
    public static void LightHighIntialize()
    {
        // InitializeConfig
        InitializeConfig();
    }

...
public class WoodMiddle : NeutralObject
{
    private static string configPath = "Fist/Neutral/Wood/WoodMiddle/Documents/config";
    ...
    public static void WoodMiddleIntialize()
    {
        // InitializeConfig
        InitializeConfig();
    }

...
public class FireMiddle : NeutralObject
{
    private static string configPath = "Fist/Neutral/Fire/FireMiddle/Documents/config";
    ...
    public static void FireMiddleIntialize()
    {
        // InitializeConfig
        InitializeConfig();
    }

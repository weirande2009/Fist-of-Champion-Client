...
public class SoilMiddle : NeutralObject
{
    private static string configPath = "Fist/Neutral/Soil/SoilMiddle/Documents/config";
    ...
    public static void SoilMiddleIntialize()
    {
        // InitializeConfig
        InitializeConfig();
    }
    ...
    protected override void Attack()
    {
        ...
        prefab.GetComponent<SoilMiddleAttackController>().Initialize(transform.position, nearestChampion.transform.position, realAttribute.attackRange, initAttackMoveSpeed, this);
    }
